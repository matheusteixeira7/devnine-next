  ...
  return (
    <Section>
      <Container>
        ...
        <Card>
          <div>
            <img src="/images/foco.svg" alt="ícone" />
            <h4>Foco</h4>
            <p>
          ...
          <div>
            <img src="/images/pratica.svg" alt="ícone" />
            <h4>Prática</h4>
            <p>
          ...
          <div>
            <img src="/images/grupo.svg" alt="ícone" />
            <h4>Grupo</h4>
            <p>
              A conexão entre Devs impulsiona seu repertório técnico, suas
              habilidades comportamentais e sua rede de contatos. Além de ajudar
              a assimilar e fixar todo aprendizado.
            </p>
          </div>
        </Card>
      </Container>
